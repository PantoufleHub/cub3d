...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/18 10:56:46 by aperron           #+#    #+#             */
/*   Updated: 2024/09/18 10:56:47 by aperron          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static long	sec_ms(time_t seconds)
{
	return (seconds * 1000);
}

static long	usec_ms(useconds_t useconds)
{
